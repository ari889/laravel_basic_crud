...
<body>
	...
	<div class="custom_signup">
        <div class="btn-group">
            <a href="{{route('teacher.index')}}" class="btn btn-primary rounded-0">All teacher</a>
          ...
          <div class="form-group">
           ...
           <input name="username" value="{{old('username')}}" type="text" class="form-control" id="username">
            ...
            <div class="form-group">
                ...
                <input name="password" value="{{old('password')}}" type="password" class="form-control" id="username">
            ...
            <div class="form-group">
                ...
                <input name="age" value="{{old('age')}}" type="text" class="form-control" id="username">
                @if($errors -> has('age'))
